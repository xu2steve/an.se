	...
	<div id="navigation">
		<ul id="menus">
			...
			<?php wp_list_pages('depth=2&title_li=0&sort_column=menu_order'); ?>
                        <li class="page_item page-item-2"><a href="http://anonymanykterister.se/forum" title="Forum">Forum</a></li>
                        <li class="page_item page-item-3"><a href="http://anonymanykterister.se/design" title="Forum">Pågående Design</a></li>
